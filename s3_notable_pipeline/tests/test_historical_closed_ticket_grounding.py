...
from s3_notable_pipeline.closed_ticket_retrieval import ClosedTicketRetrievalOutcome
from s3_notable_pipeline.historical_closed_ticket_grounding import (
...
class TestHistoricalClosedTicketGrounding(unittest.TestCase):
    ...
    @patch("s3_notable_pipeline.historical_closed_ticket_grounding.retrieve_closed_tickets_fail_soft")
    ...
    def test_retrieve_marks_unavailable_on_soft_error_outcome(self, mock_retrieve) -> None:
        ...
        self.assertIn("opensearch unavailable", meta["closed_ticket_rag_unavailable_reason"])
