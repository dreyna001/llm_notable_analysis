...
**GovCloud Path B customer-default (`core,rag,analyst_portal`):** use the SAM preset in
[`../deployment/GOVCLOUD_CUSTOMER_DEFAULT_DEPLOYMENT.md`](../deployment/GOVCLOUD_CUSTOMER_DEFAULT_DEPLOYMENT.md)
