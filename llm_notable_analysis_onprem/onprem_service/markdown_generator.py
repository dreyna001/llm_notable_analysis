...
Ported from s3_notable_pipeline/markdown_generator.py.
"""
...
def generate_markdown_report(
    ...
    if scored_ttps:
        # Normalize score field (confidence_score -> score)
        for ttp in scored_ttps:
            if 'score' not in ttp and 'confidence_score' in ttp:
                ttp['score'] = ttp['confidence_score']
            elif 'score' not in ttp:
                ttp['score'] = 0.0
