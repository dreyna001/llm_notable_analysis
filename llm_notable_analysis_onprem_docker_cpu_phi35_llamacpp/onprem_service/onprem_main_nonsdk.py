#!/usr/bin/env python3
"""On-prem notable analysis service entry point (no onprem-llm-sdk).

Same as onprem_main but uses local_llm_client_nonsdk.LocalLLMClient (requests-only
HTTP to OpenAI-compatible chat endpoints).
"""
...
from .local_llm_client_nonsdk import LocalLLMClient
from .ingest import (
    discover_files,
    normalize_notable,
    get_notable_id,
