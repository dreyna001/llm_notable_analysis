...
- `ghcr.io/dreyna001/notable-analyzer-service` (e.g. tag `1.0.0`)
...
docker tag notable-analyzer-service-analyzer:latest YOUR_REGISTRY/notable-analyzer-service:1.0.0
docker push YOUR_REGISTRY/notable-analyzer-service:1.0.0
...
```bash
docker save YOUR_REGISTRY/notable-analyzer-service:1.0.0 YOUR_REGISTRY/llama-cpp-server-cpu-phi35-llamacpp:server \
...
ANALYZER_IMAGE=YOUR_REGISTRY/notable-analyzer-service:1.0.0
```
