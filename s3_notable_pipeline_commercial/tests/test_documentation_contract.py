...
class DocumentationContractTests(unittest.TestCase):
    ...
    def test_commercial_document_renames_and_links_are_complete(self) -> None:
        expected = (
            ...
            "deploy/terraform/foundation/main.tf",
            "deploy/terraform/foundation/terraform.tfvars.example",
            "deploy/terraform/foundation/README.md",
            "deploy/terraform/network/main.tf",
            "deploy/terraform/network/README.md",
            "deploy/terraform/kms/main.tf",
            "deploy/terraform/kms/README.md",
            "deploy/terraform/ecr/main.tf",
            "deploy/terraform/ecr/README.md",
        )
        retired = (
