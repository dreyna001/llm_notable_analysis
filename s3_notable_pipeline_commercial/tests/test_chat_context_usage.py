...
from s3_notable_pipeline.chat_context_usage import (
    build_context_usage,
...
from s3_notable_pipeline.portal_chat import ChatTurn, _context_usage_for_request
...
class ChatContextUsageTests(unittest.TestCase):
    ...
    def test_estimate_tokens_from_text_uses_chars_per_token(self) -> None:
        tokens, method = estimate_tokens_from_text("summarize this case")
        self.assertEqual(method, "chars_per_token")
