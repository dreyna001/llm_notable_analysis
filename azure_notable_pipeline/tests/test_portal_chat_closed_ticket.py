...
from azure_notable_pipeline.closed_ticket_retrieval import (
...
from azure_notable_pipeline.portal_chat import build_case_grounded_prompt, trim_sources
from azure_notable_pipeline.portal_chat_kb import build_closed_ticket_chat_sources
...
class TestClosedTicketRetrieval(unittest.TestCase):
    ...
    def test_fail_soft_returns_outcome_with_error(self) -> None:
        ...
        with patch(
            "azure_notable_pipeline.closed_ticket_retrieval.retrieve_closed_ticket_hits",
            side_effect=RuntimeError("azure search unavailable"),
        ):
        ...
        self.assertIn("azure search unavailable", outcome.error or "")
...
class TestPortalClosedTicketIntegration(unittest.TestCase):
    ...
    def test_build_closed_ticket_sources_maps_hits(self) -> None:
        ...
        with patch(
            "azure_notable_pipeline.portal_chat_kb.retrieve_closed_tickets_fail_soft",
            ...
            sources=[
                {
                    ...
                    "ticket_id": "t1",
                    "ticket_number": "INC1",
                    "provenance": "closed_ticket_rag:azure_search",
                    "text": "Prior benign login",
                }
            ],
        )
