...
from azure_notable_pipeline.elasticsearch_investigation import (
...
class ElasticsearchInvestigationTests(unittest.TestCase):
    ...
    def test_executor_normalizes_search_results_and_filters_fields(self) -> None:
        ...
        with patch("azure_notable_pipeline.elasticsearch_investigation.requests.post", return_value=response):
