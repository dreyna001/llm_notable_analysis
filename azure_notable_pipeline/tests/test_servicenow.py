...
from azure_notable_pipeline.servicenow import (
...
class ServiceNowTests(unittest.TestCase):
    ...
    def test_draft_creation_has_no_network_side_effect(self) -> None:
        with patch("azure_notable_pipeline.servicenow.requests.post") as mock_post:
    ...
    def test_create_posts_approved_incident(self) -> None:
        ...
        with patch("azure_notable_pipeline.servicenow.requests.post", return_value=response) as mock_post:
            result = create_servicenow_incident(
