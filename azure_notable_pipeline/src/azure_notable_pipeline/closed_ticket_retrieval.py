"""Hybrid retrieval over indexed closed ServiceNow tickets (Azure AI Search)."""
...
from .azure_search_retrieval import retrieve_hybrid_documents, tenant_id_for
...
def retrieve_closed_ticket_hits(
    *,
    ...
    search_adapter = adapter or AzureSearchAdapter.from_config(config, index_name=index)
