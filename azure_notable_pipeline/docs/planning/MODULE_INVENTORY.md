...
| `case_archive.py` | Tier C | `case_archive.py` + `blob_store.py` + `cosmos_store.py` | analyst portal | Deferred | Phase 2/3 archive tests |
...
| `case_embed.py` | Tier C | same filename + Azure gateways | analyst portal | Deferred | Phase 2/3 embed tests |
...
| `embed_handler.py` | Tier C | same filename + queue wrapper | analyst portal | Phase 1 strict native dispatcher present; Blob/Cosmos workflow deferred | Phase 1 queue contract plus Phase 2/3 embedding tests |
...
| `lambda_handler.py` | AWS-only/replaced | `blob_handler.py` + `function_app.py` | core intake | Omitted; native intake shell created | Phase 1 queue/event tests |
...
| `ttp_analyzer.py` | Tier C | same filename + `azure_anthropic_gateway.py` | core analysis | Deferred; ATT&CK asset retained | Phase 1 prompt/golden/native gateway tests |
...
| `test_case_archive.py` | Port behavior assertions to Blob/Cosmos fakes | Phase 2/3 |
...
| `test_case_embed.py` | Port to Azure embeddings/Cosmos/Blob fakes | Phase 2/3 |
...
| `test_embed_handler.py` | Replaced by native queue-trigger tests | Phase 3 |
