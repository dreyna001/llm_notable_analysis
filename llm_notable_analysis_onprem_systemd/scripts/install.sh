...
echo "  sudo bash scripts/configure_closed_ticket_vision_defaults.sh --config-env /etc/notable-analyzer/config.env  # image attachments"
echo ""
echo "Verify:"
...
echo "  sudo bash scripts/verify_image_ingest_prerequisites.sh --config-env /etc/notable-analyzer/config.env  # OCR/PDF/Granite when image ingest is in scope"
echo "  sudo bash scripts/upgrade_granite_image_ingest.sh --bundle-dir /path/to/image-ingest-bundle  # existing Mixedbread hosts: migrate + Granite defaults"
echo ""
