...
- in scope: `llm_notable_analysis_onprem_systemd/src/llm_notable_analysis_onprem_systemd/onprem_service/local_llm_client.py`
...
- `llm_notable_analysis_onprem_systemd/src/llm_notable_analysis_onprem_systemd/onprem_service/local_llm_client.py`
  - add SPL-grounding prompt block
  - add retrieval invocation
  - add grounding-aware validation
  - add citation/ref handling
- `llm_notable_analysis_onprem_systemd/src/llm_notable_analysis_onprem_systemd/onprem_service/markdown_generator.py`
